...
namespace DeepUnity
{
    ...
    {
        public class Gemma3GPUFP16Model : IDisposable
        {
            ComputeShader cs;
            ...
            public Gemma3GPUFP16Weights weights;
            public Gemma3GPUFP16Cache cache;
            ...
            public Gemma3GPUFP16Model(string paramsPath, int cacheCapacity)
            {
                ...
                cs = DeepUnityMeta.Gemma3FP16CS;
                CacheKernelIds();

                weights = new Gemma3GPUFP16Weights(paramsPath);
                cache = new Gemma3GPUFP16Cache(numLayers, cacheCapacity, headsKV, headDim);
