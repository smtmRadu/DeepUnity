## This script is used to transform gemma's parameters into fp16 bin files
## that will be imported in Unity for the Gemma3GPUFP16 inference pipeline.
...
os.makedirs("params_it", exist_ok=True)

model._modules["model"]

norm = model._modules["model"].norm
with open(f"params_it/norm.bin", "wb")as f:
...
os.makedirs("params_it/lm_head", exist_ok=True)
...
for idx, chunk in enumerate(chunks):
    ...
    with open(f"params_it/lm_head/part_{idx}.bin", "wb") as f:
