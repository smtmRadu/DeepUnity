...
namespace DeepUnity.Modules
{
    ...
    public class Qwen3GQA
    {
            ...
            string layer_params_path = null)
        {
            ...
            this.q_norm = new Qwen3RMSNorm(this.head_dim, eps: qk_norm_eps, layer_params_path + "/self_attn_q_norm.bin");
            this.k_norm = new Qwen3RMSNorm(this.head_dim, eps: qk_norm_eps, layer_params_path + "/self_attn_k_norm.bin");

            this.scaling = MathF.Pow(head_dim, -0.5f);
