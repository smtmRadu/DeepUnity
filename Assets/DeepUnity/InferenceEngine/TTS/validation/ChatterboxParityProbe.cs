...
namespace DeepUnity
{
    namespace ChatterboxModeling
    {
        ...
        public class ChatterboxParityProbe : MonoBehaviour
        {
            ...
            public string dumpDir = "Assets/DeepUnity/InferenceEngine/TTS/validation/dump";
            ...
            IEnumerator Run()
            {
                ...
                var tokenizer = new ChatterboxTokenizer("Assets/DeepUnity/InferenceEngine/TTS/Chatterbox/ChatterboxTokenizer");
