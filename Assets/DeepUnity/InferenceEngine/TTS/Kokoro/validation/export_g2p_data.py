...
trained against) into two TSV files next to the C# G2P (ChatterboxTokenizer.* convention):
    ...
    Assets/DeepUnity/InferenceEngine/TTS/Kokoro/KokoroG2P.gold.tsv
    Assets/DeepUnity/InferenceEngine/TTS/Kokoro/KokoroG2P.silver.tsv
...
def main():
    ...
    args = ap.parse_args()
    out_dir = os.path.normpath(os.path.join(HERE, ".."))   # Assets/DeepUnity/InferenceEngine/TTS/Kokoro
