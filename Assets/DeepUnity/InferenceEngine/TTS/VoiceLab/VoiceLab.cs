...
namespace DeepUnity
{
    // VoiceLab — the TTS audition scene (Assets/DeepUnity/InferenceEngine/TTS/VoiceLab/VoiceLab.unity, built by
    ...
    public class VoiceLab : MonoBehaviour
    {
        ...
        const string PRESETS_PATH = "Assets/DeepUnity/InferenceEngine/TTS/VoiceLab/voice_presets.json";
