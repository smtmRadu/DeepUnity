...
namespace DeepUnity
{
    namespace Gemma3Modeling
    {
        ...
        // Assets/DeepUnity/InferenceEngine/LLM/OPTIMIZATIONS.md for the full story):
        ...
        public class Gemma3Weights : IDisposable
        {
            ...
            public Gemma3Weights(string paramsPath, LLMQuant quant = LLMQuant.FP16)
            {
                ...
                if (!System.IO.Directory.Exists(paramsPath))
                    throw new System.IO.DirectoryNotFoundException(
                        ...
                        "Assets/DeepUnity/InferenceEngine/import_params.py — e.g. `python import_params.py google/gemma-3-270m-it " +
            ...
            // #31 probes: lets Gemma3Model.LoadBlockingForProbe drive a fresh pump synchronously in
