...
namespace DeepUnity
{
    ...
    public class Gemma3ForCausalLM : LLM
    {
        ...
        public Gemma3ForCausalLM(
            ...
            string tokenizer_path = "Assets/DeepUnity/InferenceEngine/LLM/Gemma3/Gemma3TokenizerFast.json",
        ...
        /// </summary>
        public static IEnumerator Prewarm(string tokenizer_path = "Assets/DeepUnity/InferenceEngine/LLM/Gemma3/Gemma3TokenizerFast.json")
        {
        ...
        {
            const int CHUNK = 8;
            // Prefill pacing = the Backend Tradeoff dial's steps/frame (see
            // Qwen3_5.ForwardPromptChunked — same pattern, same yield unit).
