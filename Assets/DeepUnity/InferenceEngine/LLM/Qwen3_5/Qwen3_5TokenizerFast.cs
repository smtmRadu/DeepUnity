...
namespace DeepUnity
{
    ...
    public class Qwen3_5TokenizerFast : TokenizerBase
    {
        ...
        public Qwen3_5TokenizerFast(string path = "Assets/DeepUnity/InferenceEngine/LLM/Qwen3_5/Qwen3_5TokenizerFast.json", bool load_async = false)
        {
