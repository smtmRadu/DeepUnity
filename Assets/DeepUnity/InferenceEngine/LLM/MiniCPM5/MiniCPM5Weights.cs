...
namespace DeepUnity
{
    namespace MiniCPM5Modeling
    {
        ...
        // Assets/DeepUnity/InferenceEngine/LLM/OPTIMIZATIONS.md).
        //
            ...
            public MiniCPM5Weights(string paramsPath, LLMQuant quant = LLMQuant.FP16)
            {
                ...
                if (!Directory.Exists(paramsPath))
                    throw new DirectoryNotFoundException(
                        ...
                        "Assets/DeepUnity/InferenceEngine/import_params.py — e.g. `python import_params.py openbmb/MiniCPM5-1B " +
