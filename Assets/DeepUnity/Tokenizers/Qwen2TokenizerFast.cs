...
namespace DeepUnity
{
    public class Qwen2TokenizerFast : Tokenizer
    {
        public Qwen2TokenizerFast(string path_to_vocab_file = "Assets/DeepUnity/Tokenizers/Qwen2TokenizerFast.json") : base(path_to_vocab_file)
        {
            EOS_TOKEN_ID = 151643;
            PAD_TOKEN_ID = 151643;
        }
