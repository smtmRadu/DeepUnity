...
namespace DeepUnity.Tutorials.ChatDemo2D
{
    public class NPCInteractor : MonoBehaviour
    {
        ...
        IEnumerator Talk(string question)
        {
            ...
            yield return this.llm.Chat(question, max_new_tokens: 128, temperature:temperature, top_k:20, top_p:0.95f,
                presence_penalty: llm.Config.DefaultPresencePenalty, onTokenGenerated: (x) =>
            {
                response.Append(x);
