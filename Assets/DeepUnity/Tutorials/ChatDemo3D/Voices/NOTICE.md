...
`boss_theme.ogg`, `you_died.ogg`) on checkouts that carry it.

They are **NOT licensed for redistribution or commercial use**. If you fork or build anything
on this repo, replace these clips with audio you have rights to (any ~10 s clean speech clip
works as a clone reference — see `PocketTTS.CloneVoice`) — whatever you ship is on you.
