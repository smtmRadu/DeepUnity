...
namespace DeepUnity
{
    ...
    public class CameraManager : MonoBehaviour
    {
        ...
        public void AssignAllSceneCameras()
        {
            ...
            cameras = FindObjectsByType<Camera>(sortMode: FindObjectsSortMode.None).OfType<Camera>().ToList();            
        }
    }
    ...
    sealed class CameraManagerEditor : Editor
    {
        ...
        public override void OnInspectorGUI()
        {
            ...
            if (!Application.isPlaying && GUILayout.Button("Find all scene cameras"))
