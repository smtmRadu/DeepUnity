...
namespace DeepUnity
{
    ...
    public class Qwen3ForCausalLM
    {
        ...
        public Qwen3ForCausalLM(string params_path = "Assets/DeepUnity/LMMs/Qwen3/params")
        {
            this.vocab_size = Qwen3Modeling.Qwen3Config.VOCAB_SIZE;
        ...
        public IEnumerator Generate(string prompt, Qwen2TokenizerFast tokenizer, int max_new_tokens = 128, float temperature = 0.7f, int top_k = 20, float top_p = 0.95f, float min_p = 0)
        {
