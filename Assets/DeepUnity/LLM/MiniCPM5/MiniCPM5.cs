...
namespace DeepUnity
{
    ...
    public class MiniCPM5ForCausalLM : LLM
    {
        ...
        public MiniCPM5ForCausalLM(
            ...
            string tokenizer_path = "Assets/DeepUnity/LLM/MiniCPM5/MiniCPM5TokenizerFast.json",
        ...
        /// </summary>
        public static IEnumerator Prewarm(string tokenizer_path = "Assets/DeepUnity/LLM/MiniCPM5/MiniCPM5TokenizerFast.json")
        {
