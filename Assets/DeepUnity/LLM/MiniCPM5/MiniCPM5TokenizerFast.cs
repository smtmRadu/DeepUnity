...
namespace DeepUnity
{
    ...
    public class MiniCPM5TokenizerFast
    {
        ...
        public MiniCPM5TokenizerFast(string path = "Assets/DeepUnity/LLM/MiniCPM5/MiniCPM5TokenizerFast.json", bool load_async = false)
        {
