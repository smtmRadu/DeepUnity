...
namespace DeepUnity
{
    public class Gemma3TokenizerFast : BPETokenizer
    {
        ...
        public Gemma3TokenizerFast(string path_to_vocab_file = "Assets/DeepUnity/LLM/Gemma3/Gemma3TokenizerFast.json", bool load_async = false) : base(path_to_vocab_file, load_async)
        {
