...
namespace DeepUnity
{
    ...
    public class Gemma3ForCausalLM : LLM
    {
        ...
        public Gemma3ForCausalLM(
            ...
            string tokenizer_path = "Assets/DeepUnity/LLM/Gemma3/Gemma3TokenizerFast.json",
        ...
        /// </summary>
        public static IEnumerator Prewarm(string tokenizer_path = "Assets/DeepUnity/LLM/Gemma3/Gemma3TokenizerFast.json")
        {
