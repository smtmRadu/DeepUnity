...
{
    /// <summary>
    /// Builds the VoiceLab TTS-audition scene (Assets/DeepUnity/TTS/VoiceLab/VoiceLab.unity):
    ...
    {
        const string ROOT = "Assets/DeepUnity/TTS/VoiceLab";
        ...
        static void BuildLeftPanel(Transform canvas, VoiceLab lab)
        {
            ...
            MakeTMP("Hint", panel.transform,
                    "Saving appends/updates Assets/DeepUnity/TTS/VoiceLab/voice_presets.json and logs the " +
