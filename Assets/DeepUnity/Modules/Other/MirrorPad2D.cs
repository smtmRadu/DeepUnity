...
{
    /// <summary>
    /// Also known as Reflexion padding. <br></br>
    ...
    /// </summary>
    [Serializable]
    public class MirrorPad2D : IModule
    {
        ...
        /// W_out = W_in + 2 * padding.<br />
        /// </summary>
        public MirrorPad2D(int padding)
        {
            if (padding < 1)
        ...
        public object Clone()
        {
            return new MirrorPad2D(padding);
        }
        ...
        public Tensor Forward(Tensor input)
        {
            ...
            return Tensor.MatPad(input, padding, PaddingType.Mirror);
        }
