...
namespace DeepUnity.Modules
{
    ...
    /// </summary>
    public class EmbeddingFP16 : ILearnable, IModule
    {
        ...
        public EmbeddingFP16(int num_embeddings, int embedding_dim, int? pad_idx = null, InitType init = InitType.Normal, float? max_norm = null, NormType normType = NormType.EuclideanL2, float norm_eps = 1e-12F)
        {
            if (num_embeddings < 2)
