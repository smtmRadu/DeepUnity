...
![version](https://img.shields.io/badge/version-v0.9.9.6-blue)
...
###### _Image reconstruction by a Variational Auto-Encoder (VAE) trained on MNIST dataset. (original - first line, reconstructed - second line)_
